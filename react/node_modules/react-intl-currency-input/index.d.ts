...
type IntlCurrencyInputProps = React.PropsWithChildren & {
...
declare const IntlCurrencyInput: {
    ({ component: InputComponent, value, defaultValue, config, currency, max, autoFocus, autoSelect, autoReset, onChange, onBlur, onFocus, onKeyPress, inputRef, ...otherProps }: IntlCurrencyInputProps): JSX.Element;
    propTypes: {
        defaultValue: prop_types.Requireable<number>;
        value: prop_types.Requireable<number>;
        max: prop_types.Requireable<number>;
        component: prop_types.Validator<NonNullable<prop_types.ReactNodeLike>>;
        currency: prop_types.Validator<string>;
        config: prop_types.Validator<NonNullable<prop_types.InferProps<{}>>>;
        autoFocus: prop_types.Validator<boolean>;
        autoSelect: prop_types.Validator<boolean>;
        autoReset: prop_types.Validator<boolean>;
        onChange: prop_types.Validator<(...args: any[]) => any>;
        onBlur: prop_types.Validator<(...args: any[]) => any>;
        onFocus: prop_types.Validator<(...args: any[]) => any>;
        onKeyPress: prop_types.Validator<(...args: any[]) => any>;
        inputRef: prop_types.Requireable<NonNullable<((...args: any[]) => any) | prop_types.InferProps<{
            current: prop_types.Requireable<any>;
        }> | null | undefined>>;
    };
    defaultProps: {
        component: string;
...
export { IntlCurrencyInput as default };
